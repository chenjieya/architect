...
在上面的代码中，有一个 new ESLint，ESLint 是 eslint 里面提供的一个类，关于在实例化这个类的时候，配置对象提供了哪些配置项，可以参阅：[https://eslint.org/docs/latest/integrate/nodejs-api#-new-eslintoptions](https://eslint.org/docs/latest/integrate/nodejs-api#-new-eslintoptions)
...
可以看到，内部实际上调用了 eslint 实例对象上面的 lintFiles 方法，关于 eslint 实例对象有哪些方法，可以参阅官方的 API 文档：[https://eslint.org/docs/latest/integrate/nodejs-api#-eslintlintfilespatterns](https://eslint.org/docs/latest/integrate/nodejs-api#-eslintlintfilespatterns)
