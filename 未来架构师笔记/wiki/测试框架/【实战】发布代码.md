...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251105160344127.png)

最后一步就是通过 npm publish 进行发布即可。注意发布之前也要确保工作区是干净的。具体操作如下图所示：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251105160336590.png)
