...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127135426323.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127140434071.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127140920005.png)

服务端成功接受了我们通过 query 传递的数据。

上面两种（url param、query）是通过 url 传递数据的方式，下面 3 种是通过 body 传递数据。

## 9. formurlencoded - @Body

form urlencoded 是通过 body 传输数据，其实是把 query 字符串放在了 body 里，所以需要做 url encode：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127141121781.png)
...
测试下：
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127141227009.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127141642382.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251127141748635.png)
