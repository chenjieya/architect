...
除了 NestJS 给我们提供的众多装饰器之外，其实我们还可以自定义装饰器，我们来测试一下，首先还是生成测试项目：
...
由于是用在 Controller 上的，要取出 SetUser 装饰器上的值，我们可以使用**守卫**
...
在 guard 中使用 `reflector` 来取 `metadata`元数据：
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133251413.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133310267.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133329574.png)

现在看一下打印信息，就知道 data 和 ExecutionContext 的作用了

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133342688.png)

很明显，data 其实就是装饰器中声明的参数名，而且既然我们可以获取 request 对象，那么我们完全可以复刻 NestJS 自带的一些参数装饰器，比如`@Param`、`@Query`、`@Headers`等等
...
Controller 中使用和`@Headers`用法一模一样
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133358176.png)

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133408636.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133421057.png)

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133430457.png)

## 3. 装饰器合并

如果我们觉得装饰太多，也可以自定义装饰器将众多装饰器合并为一个，比如之前的装饰器：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133447066.png)
...
我们直接在 AppController 上使用：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251204133509931.png)
