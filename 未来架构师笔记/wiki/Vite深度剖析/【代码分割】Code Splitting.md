...
打包构建中的代码拆分（[[【Vite】代码分割（Code Splitting）：从基础到高级策略|Code Splitting]]）是一种优化技术，它将应用程序的代码拆分成多个小块（chunks），并在需要时按需加载这些代码块。这种技术的目的是提高应用程序的性能和用户体验，主要有以下几个原因：
...
4. **缓存利用**
   ...
   ![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260117161356629.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260117161411746.png)
...
**在生产环境下 Vite 完全利用 [[初始Rollup|Rollup]] 进行构建，因此拆包也是基于 Rollup 来完成的**。
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260117161458527.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260117161518603.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260117161528441.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260117161537702.png)
