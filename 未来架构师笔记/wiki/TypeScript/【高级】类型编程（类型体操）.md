...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202405192122417.png)

**调用的时候**

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202405192123190.png)
...
我们可以思考，前面提到过数组类型可以获取长度，通过 T['length']，那我们能不能把字符串类型转成数组类型呢？完全可以，通过 infer 推断和递归复用：
