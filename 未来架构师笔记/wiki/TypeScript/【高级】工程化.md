...
### 5.4 main/module/unpkg/types 与 exports
...
### 5.6 搭配 module 和 moduleResolution
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202406162234216.png)
...
>
> ![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202406162235420.png)
>
> 选择`Select Typescript Version...`
>
> ![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202406162235247.png)
>
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202406162236572.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/202406162237074.png)
...
我们自己当然也能编写类型声明文件，但是声明文件`.d.ts`大多数时候是第三方库一起使用的，在 nodejs 环境下，单独去声明`.d.ts`文件没有太大的意义，首先要了解这一点。所以，要使用`.d.ts`声明文件的场景一般是：
