...
![relation.excalidraw](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/obsidian/1781942399793_202605251100825.svg)
...
只要一个目录中包含`__init__.py`模块，Python 就会将该目录其视为一个包
...
2. `sys.path` 3. 当前脚本所在目录 4. `PYTHONPATH`  环境变量中的路径 5. Python 内置模块 6. 第三方包（`site-packages`）
