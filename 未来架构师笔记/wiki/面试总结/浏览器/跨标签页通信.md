...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224135237321.png)
...
### 2.3 _LocalStorage window.onstorage_ 监听
...
### 2.4 _Shared Worker_ 定时器轮询（ _setInterval_ ）
...
### 2.5 _[[IndexedDB]]_ 定时器轮询（ _setInterval_ ）
...
### 2.6 _cookie_ 定时器轮询（ _setInterval_ ）
...
### 2.7 _window.open、window.postMessage_
