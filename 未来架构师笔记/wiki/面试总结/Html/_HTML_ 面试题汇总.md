...
> 参考答案：
>
> 它是 _HTML_ 的[[文档声明]]，通过它告诉浏览器，使用哪一个 _HTML_ 版本标准解析文档。
>
...
## 2. 什么是可[[替换元素]]，什么是非可替换元素，它们各自有什么特点？
...
## 21. 知道什么是[[微格式]]吗？谈谈理解。在前端构建中应该考虑微格式吗？
