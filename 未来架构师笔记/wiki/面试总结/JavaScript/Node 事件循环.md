...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114250837.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114259220.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114344344.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114352576.png)
...
### 2.4 _Node.js_ 中的事件循环

#### 2.4.1 _Node.js_ 事件循环介绍
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114414691.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114422934.png)

#### 2.4.2 事件循环的 _6_ 个阶段

其中 _libuv_ 引擎中的事件循环分为 _6_ 个阶段，它们会按照顺序反复运行。每当进入某一个阶段的时候，都会从对应的回调队列中取出函数去执行。当队列为空或者执行的回调函数数量到达系统设定的阈值，就会进入下一阶段。

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114437180.png)
...
#### 2.4.4 _Node.js_ 与浏览器的事件队列的差异

浏览器环境下，就两个队列，一个宏任务队列，一个微任务队列。微任务的任务队列是每个宏任务执行完之后执行。

在 _Node.js_ 中，每个任务队列的每个任务执行完毕之后，就会清空这个微任务队列。

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114504081.png)
