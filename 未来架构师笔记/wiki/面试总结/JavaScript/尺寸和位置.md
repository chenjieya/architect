...
#### 1.1.1 _clientWidth_ 和 _clientHeight_ 属性
...
#### 1.1.2 _offsetWidth_ 和 _offsetHeight_ 属性
...
#### 1.1.3 _clientTop_ 和 _clientLeft_ 属性
...
#### 1.1.4 _offsetLeft_ 和 _offsetTop_ 属性
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114657210.png)
...
#### 1.1.5 _scrollHeight_ 和 _scrollWidth_ 属性
...
#### 1.2.1 _scrollTop_ 和 _scrollLeft_ 属性
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114752851.png)

我们分别点击该盒子的最左上角和最右下角，打印出来的值分别是（_20 , 20_）和 （_241 , 241_），可以看出这确实是以浏览器左上角坐标的（ _0 , 0_ ）为原点来进行计算的。

### 2.2 _screenX_ 和 _screenY_ 属性
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224114808513.png)

我们将浏览器缩小，同样是点击 _container_ 盒子的最左上角，打印出来的是（_368 , 365_），因为这是以屏幕最左上角为原点的。

### 2.3 _offsetX_ 和 _offsetY_ 属性
