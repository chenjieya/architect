...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224112407942.png)
...
#### 2.4.1 call、apply、bind 方法修改 this 指向
...
实际上前面讲过，箭头函数的 _this_ 指向与普通函数不一样，它的 _this_ 指向始终是指向的外层作用域。所以这里的 _this_ 实际上是指向的全局对象。

如果证明呢？

方法很简单，将这段代码放入浏览器运行，在浏览器中用 _var_ 所声明的变量会成为全局对象 _window_ 的一个属性，如下：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224112517420.png)
