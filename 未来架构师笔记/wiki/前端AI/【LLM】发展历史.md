...
3. GAN：生成对抗网络，生成类任务
4. Transformer：多模态/**语言**模型/NLP 为主（现已统治 DL）
...
| 2021+    | Diffusion Models    | 生成模型     | 图像生成（如 Stable Diffusion） | GAN 之外的新方向                 |
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260130104630748.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260130104641063.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260130104650422.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260130104707381.png)
...
- 第二波（2018 ～至今）：以 [[【LLM】Transformer|Transformer]] 为核心架构的大规模预训练模型兴起，依托海量语料数据，实现了更强的语言理解与生成能力。
