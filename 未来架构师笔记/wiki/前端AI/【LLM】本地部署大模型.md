...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260130160314134.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260130160333749.png)
...
4. ollama run <模型名称>：拉取并且运行模型 5. 存在：直接运行模型 6. 不存在：先拉取下来，然后运行
...
这里的参数量以 B 为单位，B 来自于英语单词 billion（十亿），因此例如参数量写的是 7B，则意味着参数量为 70 亿。

#### 2.2.2 **图像处理类大模型（Vision / Multimodal Models）**
