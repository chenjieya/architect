...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251203101338762.png)

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251203101347100.png)

而且 @Controller 和 @Injectable 的装饰器也是这样实现的：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251203101400264.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251203101459984.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251203101533670.png)

就是获取构造器的参数类型的。这个常量就是我们上面说的那个：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20251203101549167.png)
