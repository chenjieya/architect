...
​ 1 个 master 节点 192.168.122.93

​ 2 个工作节点 192.168.122.94 192.168.122.92

3、122.52 ansible 配置

​ 1）ansible 清单文件/etc/ansible/hosts
...
​ 2) ansible 配置文件/etc/ansible/ansible.cfg
...
4、附件中的目录 ansible，在你装好 ansible 后，请整个移动到 122.52 的/etc/目录下

5、附件 1 中的目录 dockerfile, 请整个移动到 122.52 的/usr/local/src/目录下
