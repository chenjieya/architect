...
created: 2026-08-03
description: "If you've built projects with Vite, chances are you've also used Hot Module Replacement (HMR). HMR allows you to update your code without..."
tags:
  - "clippings"
---
...
## 1. What it takes to replace modules
...
![HMR lifecycle graph](https://bjornlu.com/_app/immutable/assets/hmr-lifecycle.n6wrbbAe.png)
...
![HMR boundary](https://bjornlu.com/_app/immutable/assets/hmr-boundary.Cw_4UlKc.png)
...
### 1.4 import.meta.hot.invalidate()
...
![HMR start flow](https://bjornlu.com/_app/immutable/assets/hmr-start-flow.Co39Dn9R.png)
...
![HMR propagation advanced](https://bjornlu.com/_app/immutable/assets/hmr-propagation-advanced.B0CnTinl.png)
...
![HMR client](https://bjornlu.com/_app/immutable/assets/hmr-client.CHFVdTf3.png)
...
### 3.2 Handling payloads from the server
...
### 5.1 Where can I find the source code for Vite's HMR implementation?
...
### 5.2 Are there any HMR examples to learn from?
...
### 5.3 How does Vite's implementation differ from Webpack and others?
...
### 5.4 How does HMR work in server-side rendering?
...
### 5.5 How can I trigger a page reload in handleHotUpdate()?
...
### 5.6 Is there any specification for the HMR API?

The only specification I'm aware of is [https://github.com/FredKSchott/esm-hmr](https://github.com/FredKSchott/esm-hmr), which had been archived. Vite had implemented the specification when it started, but had since diverged slightly, e.g. `import.meta.hot.decline()` is not implemented.
...
### 5.7 Are there any other resources to learn HMR?
