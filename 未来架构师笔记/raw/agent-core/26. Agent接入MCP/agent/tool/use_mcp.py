...
_mcp_config_path = os.path.join(os.path.dirname(__file__), "..", ".agents", "mcp.json")
with open(_mcp_config_path, "r", encoding="utf-8") as _f:
    mcp = json.load(_f)
...
def use_mcp(server_name: str, tool_name: str, arguments: dict = None):  # type: ignore
