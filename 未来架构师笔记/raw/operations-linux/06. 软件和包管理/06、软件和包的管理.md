...
​ b、局域网 ftp/http 等服务提供（可以整个局域网使用）

​ c、公网知名配置（阿里云仓库、centos 自个仓库）

​ 2）客户端设置

​ /etc/yum.repos.d/diy.repo（rhel8/9 的仓库配置文件）

​ a、本地目录共享方式，其内容如下

​ （确保 iso 已经挂载在/mnt 路径下（mount /dev/sr0 /mnt）
