...
**参数三：** 属性描述对象，_其实就是js的Object.defineProperty()中的属性描述对象{value:xxx,writable:xxx, enumerable:xxx, configurable:xxx}_

前面讲属性装饰器时也提到过参数一也是这种情况。如果非要区分开静态方法和实例方法，其实分开设置也行：
