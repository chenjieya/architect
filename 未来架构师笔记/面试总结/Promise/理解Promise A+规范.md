...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134441229.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134457260.png)

2. 每个任务对象，都应该有两个阶段、三个状态

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134503194.png)
...
3. `挂起->完成`，称之为`resolve`；`挂起->失败`称之为`reject`。任务完成时，可能有一个相关数据；任务失败时，可能有一个失败原因。
   ...
   ![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134511145.png)

4. 可以针对任务进行后续处理，针对完成状态的后续处理称之为onFulfilled，针对失败的后续处理称之为onRejected

   ![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134524756.png)
