...
- _transition-property_：指定过渡的 *CSS* 属性
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134047174.png)
...
该属性主要用于设置一个属性过渡到另一个属性所需要的时间，单位为秒(_s_)或者毫秒(_ms_)。默认值为 *0*，代表变换是即时的。

_**transition-timing-function**_

该属性用于设置过渡的速度，有如下的取值：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134053757.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134107825.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134116989.png)
...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224134133462.png)
