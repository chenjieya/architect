...
![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224133023436.png)

_Google_ 和亚马逊的研究表明，_Google_ 页面加载的时间从 _0.4_ 秒提升到 _0.9_ 秒导致丢失了 _20%_ 流量和广告收入，对于亚马逊，页面加载时间每增加 _100ms_ 就意味着 _1%_ 的销售额损失。

可见，页面的加载速度对于用户有着至关重要的影响。

一个好的交互效果可能是这样的：

![image.png](https://picgo-1300696809.cos.ap-beijing.myqcloud.com/20260224133034209.png)

当然，性能优化是来自方方面面的。

这里我们主要来看 _CSS_ 方面能够进行哪些性能优化。
...
这里推荐参阅 _CSS_ 规范-优化方案：*http://nec.netease.com/standard/css-optimize.html*
...
更多的 _CSSLint_ 规则可以参阅：*https://github.com/CSSLint/csslint*
