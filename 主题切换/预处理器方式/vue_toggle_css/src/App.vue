    ...
    <div class="app-header">
      ...
      <div class="app-header-right">
        ...
        <button class="profile-btn">
          <img src="https://picsum.photos/100/100?r=0" />
          <span>Amelia</span>
        </button>
      </div>
            ...
            <div class="project-box" style="background-color: #fee4cb">
              ...
              <div class="project-box-footer">
                <div class="participants">
                  <img src="https://picsum.photos/100/100?r=1" alt="participant" />
                  <img src="https://picsum.photos/100/100?r=2" alt="participant" />
          ...
          <div class="project-box-wrapper">
            <div class="project-box" style="background-color: #e9e7fd">
              ...
              <div class="project-box-content-header">
                ...
                <p class="box-content-subheader">Coding</p>
              </div>
              <div class="box-progress-wrapper">
                <p class="box-progress-header">Progress</p>
                <div class="box-progress-bar">
              ...
              <div class="project-box-footer">
                <div class="participants">
                  <img src="https://picsum.photos/100/100?r=4" alt="participant" />
                  <img src="https://picsum.photos/100/100?r=5" alt="participant" />
          ...
          <div class="project-box-wrapper">
            <div class="project-box" style="background-color: #ffd3e2">
              ...
              <div class="project-box-footer">
                <div class="participants">
                  <img src="https://picsum.photos/100/100?r=2" alt="participant" />
                  <img src="https://picsum.photos/100/100?r=3" alt="participant" />
                ...
                <div class="days-left" style="color: #df3670">2 Days Left</div>
              </div>
            </div>
          </div>
          <div class="project-box-wrapper">
            <div class="project-box" style="background-color: #c8f7dc">
              ...
              <div class="project-box-footer">
                <div class="participants">
                  <img src="https://picsum.photos/100/100?r=6" alt="participant" />
                  <img src="https://picsum.photos/100/100?r=7" alt="participant" />
                ...
                <div class="days-left" style="color: #34c471">2 Days Left</div>
              </div>
            </div>
          </div>
          <div class="project-box-wrapper">
            <div class="project-box" style="background-color: #d5deff">
              ...
              <div class="project-box-content-header">
                <p class="box-content-header">Developing</p>
                <p class="box-content-subheader">Coding</p>
              </div>
              <div class="box-progress-wrapper">
                <p class="box-progress-header">Progress</p>
              ...
              <div class="project-box-footer">
                <div class="participants">
                  <img src="https://picsum.photos/100/100?r=8" alt="participant" />
                  <img src="https://picsum.photos/100/100?r=9" alt="participant" />
                ...
                <div class="days-left" style="color: #4067f9">2 Days Left</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="messages-section">
        ...
        <div class="messages">
          <div class="message-box">
            <img src="https://picsum.photos/100/100?r=1" alt="profile image" />
            <div class="message-content">
              ...
              <p class="message-line">
                Our recent research findings have provided valuable insights and direction for the
                project.😄
              </p>
              <p class="message-line time">Jul, 12</p>
            </div>
          </div>
          <div class="message-box">
            <img src="https://picsum.photos/100/100?r=2" alt="profile image" />
            <div class="message-content">
              <div class="message-header">
              ...
              <p class="message-line">
                We have implemented a new feature that significantly enhances the functionality of
                our product.
              </p>
              <p class="message-line time">Jul, 12</p>
            </div>
          ...
          <div class="message-box">
            <img src="https://picsum.photos/100/100?r=3" alt="profile image" />
            <div class="message-content">
              <div class="message-header">
              ...
              <p class="message-line">
                We made progress on the project, completed development phase, and began testing. 🤩
              </p>
              <p class="message-line time">Jul, 12</p>
            </div>
          </div>
          <div class="message-box">
            <img src="https://picsum.photos/100/100?r=4" alt="profile image" />
            <div class="message-content">
              <div class="message-header">
              ...
              <p class="message-line">
                The project is progressing smoothly and we anticipate meeting all project
                milestones.
              </p>
              <p class="message-line time">Jul, 11</p>
            </div>
          </div>
        </div>
      </div>
...
.os-default-active {
  ...
  border: 1px dashed;
  @include themeMixin {
    border-color: getVar(main-color);
    color: getVar(main-color);
  }
  display: flex;
  justify-content: center;
  align-items: center;
...
.search-wrapper {
  ...
  overflow: hidden;
  @include themeMixin {
    background-color: getVar(search-area-bg);
    color: getVar(light-font);
  }
}
.dark .search-wrapper {
  box-shadow: none;
...
.add-btn {
  color: #fff;
  @include background_color(button-bg);
  padding: 0;
  border: 0;
  border-radius: 50%;
  width: 32px;
...
.app-sidebar-link:hover {
  @include themeMixin {
    background-color: getVar(link-color-hover);
    color: getVar(link-color-active);
  }
}
.app-sidebar-link.active {
  @include themeMixin {
    background-color: getVar(link-color-active-bg);
    color: getVar(link-color-active) !important;
  }
}

.projects-section {
  flex: 2;
  @include background_color(projects-section);
  border-radius: 32px;
...
.item-status:not(:last-child) .status-type:after {
  ...
  border-radius: 50%;
  border: 1px solid;
  @include border_color(secondary-color);
}
...
.status-type {
  position: relative;
  padding-right: 24px;
  @include font_color(secondary-color);
}
...
.message-box {
  @include themeMixin {
    border-top: 1px solid getVar(message-box-border);
  }
  padding: 16px;
  display: flex;
...
.message-box:hover {
  @include themeMixin {
    background-color: getVar(message-box-hover);
    border-top-color: getVar(link-color-hover);
  }
}
...
.project-box {
  ...
  border-radius: 30px;
  padding: 16px;
  @include background_color(main-color-card);
}
.project-box-header {
  display: flex;
  align-items: center;
...
.messages-btn {
  ...
  display: none;
  @include themeMixin {
    background-color: getVar(message-btn);
    color: getVar(main-color);
  }
}
